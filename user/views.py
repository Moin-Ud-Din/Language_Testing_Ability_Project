...
def pi_test(request):
    ...
    if request.method == 'POST':
        ...
        # checkbox1_values = data.get("checkbox1_pi", [])
        ...
        # predictive_list = PredictiveIndex.objects.all()
        # print(predictive_list.count())
        # # Convert the queryset to a list of dictionaries
        # predictive_data = list(predictive_list.values())
...
def send_email_otp(request, email):
    ...
    #     # Handle GET requests with an appropriate response
    #     return HttpResponse("This endpoint is accessible via GET requests.")
